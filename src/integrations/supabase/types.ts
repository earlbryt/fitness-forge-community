...
export type Database = {
  public: {
    Tables: {
      ...
      challenge_workouts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "challenge_workouts_participant_id_fkey"
      ...
      location_points: {
        ...
        Relationships: [
          {
            foreignKeyName: "location_points_workout_id_fkey"
            columns: ["workout_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      create_challenge: {
        Args: {
          ...
          p_condition_value: number
          p_condition_unit: string
          p_start_date: string
          p_end_date: string
          p_created_by: string
      ...
      verify_workout: {
        Args: { workout_id: string; photo_url: string }
        Returns: {
          created_at: string
          distance: number | null
          duration: number | null
    ...
    Enums: {
      workout_type: "Running" | "Cycling" | "Yoga" | "Weightlifting"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
